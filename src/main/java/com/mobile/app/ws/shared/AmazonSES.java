...
public class AmazonSES {
	...
	final String FROM = "aurbanyak@gmail.com";
	...
	final String HTMLBODY = "<h1>Please verify your email address</h1>"
			...
			+ "<a href='http://" + URL_HOST + ":8080/verification-service/email-verification.html?token=$tokenValue'>"
	...
	final String TEXTBODY = "Please verify your email address. "
			...
			+ " http://" + URL_HOST + ":8080/verification-service/email-verification.html?token=$tokenValue"
			+ " Thank you! And we are waiting for you inside!";
	...
	final String PASSWORD_RESET_HTMLBODY = "<h1>A request to reset your password</h1>"
		      ...
		      + "<a href='http://" + URL_HOST + ":8080/verification-service/password-reset.html?token=$tokenValue'>"
		  ...
		  final String PASSWORD_RESET_TEXTBODY = "A request to reset your password "
		      ...
		      + " http://" + URL_HOST + ":8080/verification-service/password-reset.html?token=$tokenValue"
		      + " Thank you!";
